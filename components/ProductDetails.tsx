          ...
          <div className="mt-6 space-y-4">
            ...
            <div className="flex items-baseline justify-between p-4 bg-brand-secondary rounded-lg">
              ...
              <div className="text-right">
                <p className="text-3xl font-bold text-brand-primary">${product.priceUSD.toFixed(2)}</p>
                <p className="text-lg text-gray-700">{(product.priceUSD * RWF_EXCHANGE_RATE).toLocaleString()} RWF</p>
              </div>
            </div>
          </div>
        )}
